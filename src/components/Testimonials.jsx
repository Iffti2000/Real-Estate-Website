...
const Testimonials = () => {
  return (
    <div className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonials'>
      ...
      <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Real Stories from those Who Found Fome with Us</p>

      <div className='flex flex-wrap justify-center gap-8'>
        {testimonialsData.map((testimonial, index) => (
          <div key={index} className='max-w-[340px] border border-gray-200 shadow-gray-400 shadow-lg rounded px-8 py-12 text-center'>
